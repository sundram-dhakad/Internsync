    ...
    const loadProfile = async () => {
            ...
            .map((item) =>
              [
                ...
                item.graduation_year
                  ? `Graduated: ${item.graduation_year}`
                  : "",
              ]
                .filter(Boolean)
                .join(" · "),
      ...
      setProfile({
        ...
        fields: [
          ...
          [
            "Preferred locations",
            student?.preferred_locations?.join(", ") || "Not provided",
          ],
        ],
      });
    };
        ...
        <Card className="glass-card border-white/20">
          <CardHeader>
            ...
            <CardDescription className="text-white/75">
              {isStudent ? "Student profile" : "Industry profile"} ·{" "}
              {profile.email}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="rounded-lg border border-white/15 bg-white/5 p-4">
              ...
              <p className="mt-1 whitespace-pre-line wrap-break-word text-white">
                {profile.description}
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3 border-t border-white/15 pt-5">
              <Button
                onClick={() =>
                  router.push(
                    isStudent ? "/student?mode=edit" : "/industry?mode=edit",
                  )
                }
